...
#title {
	...
	<table width="700" border="3" bordercolor="lightgray" align="center">
		<form action="boardModify" method="post">
			...
			<tr>
				<th>제 목</th>
				<td><input name="bTitle" type="text" size="70" maxlength="100" value="${boardContent_view.bTitle}"></td>
			</tr>
			<tr>
				<th>내 용</th>
				<td><textarea name="bContent" cols="72" rows="20">${boardContent_view.bContent}</textarea></td>
			</tr>
